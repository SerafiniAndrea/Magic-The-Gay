...
public class Libreria {
	...
	public void grixisMidrangeGenerator() {
		this.grixisMidrange.add(new Istantaneo("Abrade", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Abrade", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Abrade", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Go for the Throat", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Go for the Throat", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Go for the Throat", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Make Disappear", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Make Disappear", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Make Disappear", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Negate", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Negate", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Parasitic Grasp", 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Istantaneo("Parasitic Grasp", 2, (new ArrayList<>(){{add(null);}})));
		...
		this.grixisMidrange.add(new Terra("Xanders Lounge", Mana.Blu, Mana.Nero, Mana.Rosso, false));
		this.grixisMidrange.add(new Terra("Xanders Lounge", Mana.Blu, Mana.Nero, Mana.Rosso, false));
		this.grixisMidrange.add(new Creatura("Bladecoil Serpent", 7, 5, 4, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Bloodtithe Harvester", 2, 3, 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Bloodtithe Harvester", 2, 3, 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Bloodtithe Harvester", 2, 3, 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Bloodtithe Harvester", 2, 3, 2, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Razorlash Transmogrant", 2, 3, 1, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Sheoldred the Apocalypse", 4, 4, 5, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Sheoldred the Apocalypse", 4, 4, 5, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Reckoner Bankbuster", 2, 4, 4, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Reckoner Bankbuster", 2, 4, 4, (new ArrayList<>(){{add(null);}})));
		this.grixisMidrange.add(new Creatura("Reckoner Bankbuster", 2, 4, 4, (new ArrayList<>(){{add(null);}})));
