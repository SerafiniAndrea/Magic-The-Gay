...
public class Libreria {
	...
	public void grixisMidrangeGenerator() {
		this.grixisMidrange.add(new Istantaneo("Abrade", 2));
		this.grixisMidrange.add(new Istantaneo("Abrade", 2));
		this.grixisMidrange.add(new Istantaneo("Abrade", 2));
		this.grixisMidrange.add(new Istantaneo("Go for the Throat", 2));
		this.grixisMidrange.add(new Istantaneo("Go for the Throat", 2));
		this.grixisMidrange.add(new Istantaneo("Go for the Throat", 2));
		this.grixisMidrange.add(new Istantaneo("Make Disappear", 2));
		this.grixisMidrange.add(new Istantaneo("Make Disappear", 2));
		this.grixisMidrange.add(new Istantaneo("Make Disappear", 2));
		...
		this.grixisMidrange.add(new Creatura("Bloodtithe Harvester", 2, 3, 2));
		this.grixisMidrange.add(new Creatura("Bloodtithe Harvester", 2, 3, 2));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3));
		this.grixisMidrange.add(new Creatura("Corpse Appraiser", 3, 3, 3));
		this.grixisMidrange.add(new Creatura("Razorlash Transmogrant", 2, 3, 1));
		this.grixisMidrange.add(new Creatura("Sheoldred the Apocalypse", 4, 4, 5));
		this.grixisMidrange.add(new Creatura("Sheoldred the Apocalypse", 4, 4, 5));
		this.grixisMidrange.add(new Creatura("Reckoner Bankbuster", 2, 4, 4));
		this.grixisMidrange.add(new Creatura("Reckoner Bankbuster", 2, 4, 4));
		this.grixisMidrange.add(new Creatura("Reckoner Bankbuster", 2, 4, 4));
